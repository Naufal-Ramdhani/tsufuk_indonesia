	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form method="POST" action="#" id="reset_form" class="login100-form validate-form p-b-33 p-t-5">
					@csrf
					...
					<div class="container-login100-form-btn m-t-16">
						<button type="submit" id="reset_btn" class="login100-form-btn">
							Kirim
						</button>
					</div>
				</form>
	...
	<script>
		$(function() {
			$("#reset_form").submit(function(e) {
				...
				$.ajax({
					url: '{{ route('forgotPasswordEmail-post') }}',
					method: 'POST',
					data: $(this).serialize(),
					dataType: 'json',
					success: function(res){
						if (res.status == 400) {
							...
							window.location = '{{ route('reset-get') }}';
