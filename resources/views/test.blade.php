...
<head>
	...
	<link rel="stylesheet" href="{{ asset('template_admin') }}/assets/css/ready.css">
...
<script src="{{ asset('template_admin') }}/assets/js/plugin/chartist/chartist.min.js"></script>
<script src="{{ asset('template_admin') }}/assets/js/plugin/chartist/plugin/chartist-plugin-tooltip.min.js"></script>
<script src="{{ asset('template_admin') }}/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>
<script src="{{ asset('template_admin') }}/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js"></script>
<script src="{{ asset('template_admin') }}/assets/js/plugin/jquery-mapael/jquery.mapael.min.js"></script>
<script src="{{ asset('template_admin') }}/assets/js/plugin/jquery-mapael/maps/world_countries.min.js"></script>
...
<script src="{{ asset('template_admin') }}/assets/js/ready.min.js"></script>
